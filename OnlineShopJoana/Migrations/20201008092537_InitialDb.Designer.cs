...
namespace OnlineShopJoana.Migrations
{
    ...
    [Migration("20201008092537_InitialDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShopJoana.WEB.Data.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnlineShopJoana.WEB.Data.Entities.OrderDetailTemp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnlineShopJoana.WEB.Data.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineShopJoana.WEB.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShopJoana.WEB.Data.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("OnlineShopJoana.WEB.Data.Entities.Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId");

                    b.HasOne("OnlineShopJoana.WEB.Data.Entities.Product", "Product")
                        .WithMany()
